...
namespace Fornax.Net.Util.IO.Writers
{
    ...
    public static class FornaxWriter
    {
        ...
        /// <param name="append">append object data to file.</param>
        /// <exception cref="ArgumentNullException">file</exception>
        public static void BufferWrite<TObject>(TObject @object, string name, bool append) where TObject : class
        {
            Contract.Requires(name != null);
            if (name == null) throw new ArgumentNullException(nameof(name));
            BufferWrite(@object, new FileWrapper(name), append);
        }
        ...
        /// <returns>TObject.</returns>
        /// <exception cref="ArgumentNullException">file</exception>
        public static TObject[] BufferRead<TObject>(string filename) where TObject : class
        {
            Contract.Requires(filename != null);
            if (filename == null) throw new ArgumentNullException(nameof(filename));
            return BufferRead<TObject>(new FileWrapper(filename));
        }
        ...
        public static TObject[] BufferRead<TObject>(FileWrapper fileWrapper) where TObject : class
        {
            ...
            if (fileWrapper == null || tempinfo == null) throw new ArgumentNullException(nameof(fileWrapper));

            if (fileWrapper.File.canRead())
            {
                TObject[] obj = null;
